...
class MasarGame implements Game {
    ...
    public void init(GameContainer gc){
       ...
       try {
        ...
        this.gameData.getButtonList().add(new MenuButton(582, 660, "./res/img/Buttons/b_back.png", "Back", 1));
        this.gameData.getButtonList().add(new MenuButton(582, 660, "./res/img/Buttons/b_done.png","Done",2));
